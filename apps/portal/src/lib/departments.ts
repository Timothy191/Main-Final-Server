...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    icon: 'Database',
    description: 'Browse raw tables, schemas, and live database logs via Supabase Studio',
    color: 'violet',
    type: 'standard',
    status: 'active',
    gridSpan: 'md:col-span-1 xl:col-span-1',
    stats: { label: 'Port', value: '54323' },
    trend: [100, 100, 100, 100, 100, 100, 100, 100],
    actions: [{ label: 'Supabase Studio', href: 'http://localhost:54323' }],
  },
  {
    name: 'admin',
    displayName: 'Admin',
