...
| :----------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------- |
| [`workspace-packages.md`](./workspace-packages.md)                                         | Complete topology of the `apps/portal` workspace app and 13 `@repo/*` packages.                                                         |
| [`api-routes.md`](./api-routes.md)                                                         | Index of all 51 portal API routes and gateway endpoints categorized by domain.                                                          |
| [`portal-page-routes.md`](./portal-page-routes.md)                                         | Index of all 69 portal App Router page routes (UI surface) grouped by area, including route groups, dynamic, and parallel modal routes. |
