...
async function main() {
  ...
  const depts = [
    ...
    { id: "2545eeef-d1e5-49fa-90fd-27a097513be6", name: "access-control", display_name: "Access Control" },
    { id: "739286da-7170-43e7-bd82-748fda43ad66", name: "engineering", display_name: "Engineering" },
    { id: "05134c33-b1b6-479f-a125-fb9647d40df4", name: "control-room", display_name: "Control Room" },
    ...
    { id: "1faaafe4-ed67-4e85-9af8-50b29e6c1a13", name: "satellite-monitoring", display_name: "Satellite Monitoring" },
    { id: "ff63676b-2b14-47a5-b3ab-96883dcc7797", name: "admin", display_name: "Admin" },
    { id: "b7800380-997c-480c-a24f-e6c87931a4d2", name: "access-card-actions", display_name: "Access Card Actions" }
  ];

  const insertDept = db.prepare("INSERT OR IGNORE INTO departments (id, name, display_name) VALUES (?, ?, ?)");
  ...
  for (const u of users) {
    insertEmp.run(u.id, u.auth_id, u.department_id, u.full_name, u.role, u.accessible_departments, u.email, u.password_hash);
  }
