...
description: >-
  ...
  before multi-step or multi-file work, scoping a feature, mapping critical gaps,
  planning handoffs, or when the user says outline first / scout / map the work.
  Anti-trigger: Do not use for implementation, visual design, docs/AI sync,
  idle fill, or adversarial review — delegate to frontend-implementer,
