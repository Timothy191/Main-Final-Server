...
1. Receive gap report and design patches — [`patch-builder/references/workflow.md`](patch-builder/references/workflow.md)
2. Modify files structurally to repair errors
3. If imports/paths changed → delegate `import-auditor` before claiming done
4. Validate with `pnpm ai check` / scoped quality
